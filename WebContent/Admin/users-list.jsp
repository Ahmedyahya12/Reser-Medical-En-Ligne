                  ...
                  <div class="card-body">
                   <!-- Title and Search Bar -->
					    <div class="d-flex justify-content-between align-items-center p-3">
					      ...
					      <form class="search-form d-flex align-items-center" method="get" action="<%= request.getContextPath() %>/Admin/chercher.user">
					        <input type="text" name="motCle"  class="form-control" placeholder="Search" title="Enter search keyword"  value="${model.motCle}"/>
